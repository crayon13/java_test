...
public class KoreanProcessor {
    ...
    public static String converEnglishKeyboard(String sourceKoreanText) {
    ...
    @Test
    public void converEnglishKeyboardTest() {
        String sourceKoreanText = "맨투맨/스웨트셔츠";
        String englishKeyboardText = "aosxnaos/tmdnpxmtucm";

        assertThat(converEnglishKeyboard(sourceKoreanText)).isEqualTo(englishKeyboardText);
    }

    @Test
    public void convertAtomicWordTest() {
        String sourceKoreanText = "맨투맨/스웨트셔츠";
        String englishKeyboardText = "ㅁㅐㄴㅌㅜㅁㅐㄴ/ㅅㅡㅇㅞㅌㅡㅅㅕㅊㅡ";

        assertThat(convertAtomicWord(sourceKoreanText)).isEqualTo(englishKeyboardText);
    }
